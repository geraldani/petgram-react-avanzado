...
export const Logo = props => (
  ...
  >
    <defs>
      ...
      >
        <stop offset={0} stopColor="#45aee7" />
        <stop offset={0.17} stopColor="#bda0b2" />
        <stop offset={0.34} stopColor="#ce64a6" />
        <stop offset={0.51} stopColor="#d8f05b" />
        <stop offset={0.68} stopColor="#55ad15" />
        <stop offset={0.85} stopColor="#0055a5" />
        <stop offset={1} stopColor="#45aee7" />
      </linearGradient>
      <filter
